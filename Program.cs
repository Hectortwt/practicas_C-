...
// programa donde se ingresan datos desde consola y después se pregunta su se quiere sumar o restar
    ...
    class Program
    {
        static void Main(string[] args)
        {
           // definicion de las variables
            ...
            if (opcion == 1) { // si se seleccion la opcion 1 en tonces se sumaran los valores
                resultado = A + B;
                Console.WriteLine("oK, seleccionaste 1, la suma es:" + resultado);
            }
            else
            {
                resultado = A - B; // si se seleccion la opcion 2 entonces calcula la resta
